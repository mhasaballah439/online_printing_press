                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.print_price.index')}}">{{__('msg.sliders')}}</a>
                                </li>
                            ...
                            <div class="card">
                                @if(admin()->check_route_permission('admin.print_price.create') == 1)
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <form class="form" action="{{route('admin.print_price.store')}}" method="post"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class=" label-control"
                                                                           for="url">{{__('msg.num_paper')}} (1 {{__('msg.sar')}})
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <option value="1">{{__('msg.printing')}}</option>
                                                                <option value="2">{{__('msg.packaging')}}</option>
                                                        ...
                                                        <div class="col-md-6 d-none packaging_type_div">
                                                            <div class="form-group">
                                                                ...
                                                                <option value="0">{{__('msg.select_packaging_type')}}</option>
                                                                <option value="1">{{__('msg.without_packaging')}}</option>
                                                                <option value="2">{{__('msg.stapling_packaging_with_a_tape')}}</option>
                                                                <option value="3">{{__('msg.wire')}}</option>
                                                                <option value="4">{{__('msg.one_perforated_paper')}}</option>
                                                                <option value="5">{{__('msg.plastic_snail_packaging')}}</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
