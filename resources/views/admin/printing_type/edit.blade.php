                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.printing_type.index')}}">{{__('msg.printing_type')}}</a>
                                </li>
                            ...
                            <div class="card">
                                @if(admin()->check_route_permission('admin.printing_type.edit') == 1)
                                    <div class="card-header">
                                        <h4 class="card-title" id="basic-layout-form">{{__('msg.printing_type')}}</h4>
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            @if($printing_type)
                                                <form class="form"
                                                      action="{{route('admin.printing_type.update',$printing_type->id)}}"
                                                      method="post"
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-actions">
                                                            <a href="{{route('admin.printing_type.index')}}" type="button"
